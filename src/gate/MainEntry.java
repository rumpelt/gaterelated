...
/**
 * @author ashwani
 * an example of the command line argument is as following. following creates a bunch of file from
 * 
 * --controllertype=serialAnalyserController --dd=/home/ashwani/xyz/datastore/ --cf=/home/ashwani/xyz/babiesnotes.xml --cftype=xml --rootelement=PERSON --annset="Original markups"
 */
public class MainEntry {
	...
	public static void main(String[] args) throws ResourceInstantiationException {
	   ...
	   if (corpusfile != null) {
		   ...
		   CorpusClass cc = null;
		   if (dumptodisk != null)
			   cc = new CorpusClass(datastorage, datastorage.getEncoding(), corpusfile.getName(), 
					   annotationSet, new File(dumptodisk));
		   else
			   cc = new CorpusClass(datastorage, datastorage.getEncoding(),
					   corpusfile.getName(), annotationSet);
		   try {
		    ...
		    datastorage.add(cc);
		    if (datastorage.getSizeofcorpus() > 1) {
		    	// this branch is reachable when we have created multiple corpus
		    	cc.deleteAllDoc();
	...
	public static void addoptions(Options options) {
		...
		options.addOption("annset", "annotationset", true, "names of the annotation" +
				" which we will try to preserve. Use to discar other annotation \n" +

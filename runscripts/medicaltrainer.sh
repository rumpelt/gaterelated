...
args="--mt    --minngram=1  --cltype=randomforest --cloptions=-I:500  --ifile /usa/arao/xyz/goldset.csv    --tcol 3 --agecol 2 --idcol=1 --lcol=4  --lage 0.0 --uage 2.0 --idname=uid --ngrams 1 --removeCommonCounters --rulefile=/usa/arao/xyz/goldsetrules0-1.csv --samplesize=150 --numi=50 "
